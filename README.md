...
- [ ] Add more training data for better generalisation
...
Built as part of an NLP & Deep Learning assignment project.  
Demonstrates: preprocessing, sequence modelling, LSTM training, evaluation, and web deployment.
